 ...
 * Set these in your local .env (gitignored) and as EAS environment variables for builds.
 *
 * Platform Support:
...
> => {
  ...
  // Check if there are any active subscriptions (not just entitlements)
  // activeSubscriptions contains product identifiers of active subs
